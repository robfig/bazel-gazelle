...
GO_REPOSITORY_TOOLS_SRCS = [
	...
	"@bazel_gazelle//language/go:known_go_imports.go",
	"@bazel_gazelle//language/go:known_proto_imports.go",
	...
	"@bazel_gazelle//language/js:BUILD.bazel",
	"@bazel_gazelle//language/js/closure_library:BUILD",
	"@bazel_gazelle//language/js/closure_library:closure_library.go",
	"@bazel_gazelle//language/js:config.go",
	"@bazel_gazelle//language/js:fileinfo.go",
	"@bazel_gazelle//language/js:fix.go",
	"@bazel_gazelle//language/js:generate.go",
	"@bazel_gazelle//language/js:kinds.go",
	"@bazel_gazelle//language/js:lang.go",
	"@bazel_gazelle//language/js:resolve.go",
	...
	"@bazel_gazelle//repo:dep.go",
	"@bazel_gazelle//repo:godep.go",
	"@bazel_gazelle//repo:modules.go",
